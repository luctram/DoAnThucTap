    ...
    <body>
        ...
        <div class="mainbody container-fluid">
            ...
            <div class="col-md-9 ttcnright">
                <form action="../Controller/Servlet_EditInfoUser" method="post">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3 class="panel-title pull-left">Mô tả bản thân</h3>
                            <br><br>
                            <div class="form-horizontal">
                                <input type="text" class="form-control" id="describe" placeholder="Like #movies #kittens #travel #teacher #newyork" value="<%=user.getDescribe()%>" name="describe">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div align="center">
                                <div class="col-lg-12 col-md-12">
                                    <img class="img-thumbnail img-responsive" src="img/tram.jpg" width="300px" height="300px">
                                </div>
                                <div class="col-lg-12 col-md-12">
                                    <button class="btn btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> Tải hình mới</button>
                                    <input style="margin-top:24px;" name="" type="file" (change)="onFileSelected($event)" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <button class="btn btn-default"><i class="fa fa-fw fa-times" aria-hidden="true"></i> Hủy</button>
                    <button class="btn btn-primary"><i class="fa fa-fw fa-check" aria-hidden="true"></i> Lưu thông tin</button>
